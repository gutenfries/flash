...
int OBDIIResponseSuccessful(OBDIICommand* command, unsigned char* payload, int len) {
	...
	// For responses whose length we can anticipate, make sure the actual length
	// matches
...
void OBDIIDecodeBitfield(OBDIIResponse* response, unsigned char* responsePayload, int len) {
	response->bitfieldValue =
		(responsePayload[2] << 24) | (responsePayload[3] << 16) | (responsePayload[4] << 8) | responsePayload[5];
}
...
void OBDIIDecodeOxygenSensorValues2(OBDIIResponse* response, unsigned char* responsePayload, int payloadLen) {
	...
	response->oxygenSensorValues.fuelAirEquivalenceRatio =
		2.0 / 65536.0 * (responsePayload[2] << 8 | responsePayload[3]);
}
...
OBDIICommand OBDIIMode1Commands[] = {
	...
	{"Distance traveled with malfunction indicator lamp on",
	 ...
	 4,
	 &OBDIIDecodeUInt16},
	{"Fuel rail pressure (relative to mainfold vacuum",
	 {0x01, 0x22},
	 OBDIIResponseTypeNumeric,
	 4,
	 &OBDIIDecodeFuelRailPressure},
	{"Fuel rail gauge pressure (diesel, or gasoline direct injection",
	 {0x01, 0x23},
	 OBDIIResponseTypeNumeric,
	 4,
	 &OBDIIDecodeFuelRailGaugePressure},
	...
	{"Catalyst temperature, bank 1, sensor 1",
	 ...
	 OBDIIResponseTypeNumeric,
	 4,
	 &OBDIIDecodeCatalystTemperature},
...
OBDIICommand OBDIIMode3Command = {"Get DTCs",
								  {0x03},
...
struct OBDIICommands OBDIICommands = {
	// Mode 1
	&OBDIIMode1Commands[0], &OBDIIMode1Commands[1], &OBDIIMode1Commands[2], &OBDIIMode1Commands[3],
	&OBDIIMode1Commands[4], &OBDIIMode1Commands[5], &OBDIIMode1Commands[6], &OBDIIMode1Commands[7],
	&OBDIIMode1Commands[8], &OBDIIMode1Commands[9], &OBDIIMode1Commands[10], &OBDIIMode1Commands[11],
	&OBDIIMode1Commands[12], &OBDIIMode1Commands[13], &OBDIIMode1Commands[14], &OBDIIMode1Commands[15],
	&OBDIIMode1Commands[16], &OBDIIMode1Commands[17], &OBDIIMode1Commands[18], &OBDIIMode1Commands[19],
	&OBDIIMode1Commands[20], &OBDIIMode1Commands[21], &OBDIIMode1Commands[22], &OBDIIMode1Commands[23],
	&OBDIIMode1Commands[24], &OBDIIMode1Commands[25], &OBDIIMode1Commands[26], &OBDIIMode1Commands[27],
	&OBDIIMode1Commands[28], &OBDIIMode1Commands[29], &OBDIIMode1Commands[30], &OBDIIMode1Commands[31],
	&OBDIIMode1Commands[32], &OBDIIMode1Commands[33], &OBDIIMode1Commands[34], &OBDIIMode1Commands[35],
	&OBDIIMode1Commands[36], &OBDIIMode1Commands[37], &OBDIIMode1Commands[38], &OBDIIMode1Commands[39],
	&OBDIIMode1Commands[40], &OBDIIMode1Commands[41], &OBDIIMode1Commands[42], &OBDIIMode1Commands[43],
	&OBDIIMode1Commands[44], &OBDIIMode1Commands[45], &OBDIIMode1Commands[46], &OBDIIMode1Commands[47],
	&OBDIIMode1Commands[48], &OBDIIMode1Commands[49], &OBDIIMode1Commands[50], &OBDIIMode1Commands[51],
	&OBDIIMode1Commands[52], &OBDIIMode1Commands[53], &OBDIIMode1Commands[54], &OBDIIMode1Commands[55],
	&OBDIIMode1Commands[56], &OBDIIMode1Commands[57], &OBDIIMode1Commands[58], &OBDIIMode1Commands[59],
	&OBDIIMode1Commands[60], &OBDIIMode1Commands[61], &OBDIIMode1Commands[62], &OBDIIMode1Commands[63],
	&OBDIIMode1Commands[64], &OBDIIMode1Commands[65], &OBDIIMode1Commands[66], &OBDIIMode1Commands[67],
	&OBDIIMode1Commands[68], &OBDIIMode1Commands[69], &OBDIIMode1Commands[70], &OBDIIMode1Commands[71],
	&OBDIIMode1Commands[72], &OBDIIMode1Commands[73], &OBDIIMode1Commands[74], &OBDIIMode1Commands[75],
	&OBDIIMode1Commands[76], &OBDIIMode1Commands[77], &OBDIIMode1Commands[78],
	...
	// OBDIIM Mode 9
	&OBDIIMode9Commands[0], &OBDIIMode9Commands[1], &OBDIIMode9Commands[2]};
